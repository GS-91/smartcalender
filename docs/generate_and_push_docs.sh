...
# Definiere das Projekt- und Docs-Verzeichnis
PROJECT_DIR="/Users/ivanappl/DevOpsKalenderProjekt"
DOCS_DIR="$PROJECT_DIR/docs"
DOC_FILE="$DOCS_DIR/DockerAndCalender.md"
...
DAY="WE"
DURATION="60"
RECURRENCE="RRULE:FREQ=WEEKLY;BYDAY=$DAY"

# Sicherstellen, dass sich das Skript im richtigen Verzeichnis befindet
cd "$PROJECT_DIR" || { echo "Fehler: Projektverzeichnis nicht gefunden!"; exit 1; }
...
# Datei zu Git hinzufügen und pushen
cd "$PROJECT_DIR"
git add "$DOC_FILE"
git commit -m "Added Docker and Calendar documentation"
git push origin main

echo "DockerAndCalender.md wurde erfolgreich erstellt und auf GitHub gepusht."
